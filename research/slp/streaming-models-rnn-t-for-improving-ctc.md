---
title: "Streaming Models: RNN-T for improving CTC"
summary: "§I Large Language Models › Automatic Speech Recognition › CTC: 15.6 • ASR EVALUATION: WORD ERROR RATE ENCODER … DECODER … H <s> i t ‘ s t i m x1 xn … … i t ’ s t i m e … CTC Loss Encoder-Decoder Loss Figure 15.16 Combining the CTC and encoder-decoder loss functions."
level: "research"
...
§I Large Language Models › Automatic Speech Recognition › CTC › Streaming Models: RNN-T for improving CTC · pp. 367–367 · Speech and Language Processing (Jurafsky & Martin, 3rd ed. draft)
...
- **output** — 7 mentions
- **error** — 5 mentions
- **streaming** — 5 mentions
- **input** — 4 mentions
- **model** — 4 mentions
- **recognizer** — 4 mentions
- **rate** — 3 mentions
...
## Liens
- Up: [[research/slp/ctc]]
- ← Prev: [[research/slp/combining-ctc-and-encoder-decoder]]
