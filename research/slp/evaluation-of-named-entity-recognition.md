...
§II Annotating Linguistic Structure › Sequence Labeling for Parts of Speech and Named Entities › Evaluation of Named Entity Recognition · pp. 409–409 · Speech and Language Processing (Jurafsky & Martin, 3rd ed. draft)
...
- ← Prev: [[research/slp/conditional-random-fields-crfs]]
- Next: [[research/slp/further-details]] →
