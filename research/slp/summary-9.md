...
§I Large Language Models › Post-training: Instruction Tuning, Alignment, and Test-Time Compute › Summary · pp. 240–240 · Speech and Language Processing (Jurafsky & Martin, 3rd ed. draft)
...
- ← Prev: [[research/slp/test-time-compute]]
- Next: [[research/slp/historical-notes-9]] →
