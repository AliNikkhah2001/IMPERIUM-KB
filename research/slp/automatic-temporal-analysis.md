---
title: "Automatic Temporal Analysis"
...
§II Annotating Linguistic Structure › Information Extraction: Relations, Events, and Time › Automatic Temporal Analysis · pp. 480–483 · Speech and Language Processing (Jurafsky & Martin, 3rd ed. draft)
...
## Key terms
- **temporal** — 41 mentions
- **expression** — 34 mentions
- **time** — 31 mentions
- **week** — 30 mentions
- **timex3** — 19 mentions
- **event** — 18 mentions
...
- ← Prev: [[research/slp/temporally-annotated-datasets-timebank]]
- Next: [[research/slp/template-filling]] →
