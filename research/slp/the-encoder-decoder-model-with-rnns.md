---
title: "The Encoder-Decoder Model with RNNs"
summary: "§I Large Language Models › RNNs and LSTMs › The Encoder-Decod: CHAPTER 13 • RNNS AND LSTMS networks making use of gated units can be unrolled into deep feedforward networks and trained in the usual fashion with backpropagation."
level: "research"
...
§I Large Language Models › RNNs and LSTMs › The Encoder-Decoder Model with RNNs · pp. 308–311 · Speech and Language Processing (Jurafsky & Martin, 3rd ed. draft)
...
## Key terms
- **sequence** — 30 mentions
- **model** — 23 mentions
- **input** — 19 mentions
- **hidden** — 19 mentions
- **encoder-decoder** — 18 mentions
- **decoder** — 18 mentions
- **state** — 18 mentions
- **token** — 17 mentions
...
- ← Prev: [[research/slp/summary-common-rnn-nlp-architectures]]
- Next: [[research/slp/attention-2]] →
