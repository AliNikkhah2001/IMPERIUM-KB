...
summary: "§I Large Language Models › Retrieval-based Models › Evaluatin: CHAPTER 11 • RETRIEVAL-BASED MODELS document. We sometimes call the task of question answering given one or more documents (for example via RAG), the open book QA task, while the task of anopen book swering directly f"
level: "research"
...
§I Large Language Models › Retrieval-based Models › Evaluating Question Answering · pp. 262–262 · Speech and Language Processing (Jurafsky & Martin, 3rd ed. draft)
...
- ← Prev: [[research/slp/datasets]]
- Next: [[research/slp/summary-10]] →
