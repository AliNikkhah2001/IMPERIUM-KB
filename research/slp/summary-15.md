---
title: "Summary"
summary: "§I Large Language Models › Text-to-Speech › Summary: 16.7 • SUMMARY This chapter introduced the fundamental algorithms of text-to-speech (TTS). • A common modern algorithm for TTS is to use conditional generation with a language model over audio tokens learned by a codec model."
level: "research"
...
§I Large Language Models › Text-to-Speech › Summary · pp. 385–385 · Speech and Language Processing (Jurafsky & Martin, 3rd ed. draft)
...
- ← Prev: [[research/slp/spoken-language-models]]
- Next: [[research/slp/historical-notes-15]] →
