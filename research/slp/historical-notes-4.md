...
summary: "§I Large Language Models › Embeddings › Historical Notes: CHAPTER 5 • EMBEDDINGS Nonetheless it is useful to have intrinsic evaluations. The most common metric is to test their performance on similarity, computing the correlation between an algorithm’s word similarity scores and "
level: "research"
...
- [[pdf:Speech and Language Processing.pdf#page=124|Speech and Language Processing.pdf p. 124]]

## Liens
- Up: [[research/slp/embeddings]]
- ← Prev: [[research/slp/summary-4]]
- Next: [[research/slp/exercises-4]] →
