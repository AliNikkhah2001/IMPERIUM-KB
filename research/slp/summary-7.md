---
title: "Summary"
summary: "§I Large Language Models › Transformers › Summary: 8.9 • INTERPRETING THE TRANSFORMER which is a kind of abstract component of a network. The induction head circuit is part of the attention computation in transformers, discovered by looking at mini language models with only 1-2 a"
level: "research"
...
§I Large Language Models › Transformers › Summary · pp. 205–205 · Speech and Language Processing (Jurafsky & Martin, 3rd ed. draft)
...
- ← Prev: [[research/slp/interpreting-the-transformer]]
- Next: [[research/slp/historical-notes-7]] →
