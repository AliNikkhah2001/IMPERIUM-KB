...
§I Large Language Models › Post-training: Instruction Tuning, Alignment, and Test-Time Compute › Test-time Compute · pp. 240–240 · Speech and Language Processing (Jurafsky & Martin, 3rd ed. draft)
...
- ← Prev: [[research/slp/llm-alignment-via-preference-based-learning]]
- Next: [[research/slp/summary-9]] →
