---
title: "Summary"
summary: "§I Large Language Models › N-gram Language Models › Summary: CHAPTER 3 • N-GRAM LANGUAGE MODELS lower cross-entropy. (The cross-entropy can never be lower than the true entropy, so a model cannot err by underestimating the true entropy.) We are finally ready to see the relation b"
level: "research"
...
§I Large Language Models › N-gram Language Models › Summary · pp. 66–66 · Speech and Language Processing (Jurafsky & Martin, 3rd ed. draft)
...
- ← Prev: [[research/slp/advanced-perplexity-s-relation-to-entropy]]
- Next: [[research/slp/historical-notes-2]] →
