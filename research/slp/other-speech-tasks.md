---
title: "Other speech tasks"
summary: "§I Large Language Models › Text-to-Speech › Other speech task: CHAPTER 16 • TEXT-TO-SPEECH If we are comparing exactly two systems (perhaps to see if a particular change actually improved the system), we can also compare using CMOS (Comparative CMOS MOS)."
level: "research"
...
§I Large Language Models › Text-to-Speech › Other speech tasks · pp. 384–384 · Speech and Language Processing (Jurafsky & Martin, 3rd ed. draft)
...
- ← Prev: [[research/slp/tts-evaluation]]
- Next: [[research/slp/spoken-language-models]] →
