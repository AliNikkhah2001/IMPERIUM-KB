...
§I Large Language Models › Phonetics and Speech Feature Extraction › Summary · pp. 344–344 · Speech and Language Processing (Jurafsky & Martin, 3rd ed. draft)
...
- **frame** — 7 mentions
- **value** — 6 mentions
- **represent** — 5 mentions
- **coefficients** — 5 mentions
...
- ← Prev: [[research/slp/mfcc-mel-frequency-cepstral-coefficients]]
- Next: [[research/slp/historical-notes-13]] →
