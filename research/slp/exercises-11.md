...
§II Annotating Linguistic Structure › Context-Free Grammars and Constituency Parsing › Exercises · pp. 435–438 · Speech and Language Processing (Jurafsky & Martin, 3rd ed. draft)
...
- **parsing** — 14 mentions
- **left** — 12 mentions
- **constituent** — 12 mentions
- **context-free** — 12 mentions
- **head** — 10 mentions
- **first** — 10 mentions
...
- ← Prev: [[research/slp/historical-notes-17]]
