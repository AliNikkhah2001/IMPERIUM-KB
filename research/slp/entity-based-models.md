...
§II Annotating Linguistic Structure › Coreference Resolution and Entity Linking › Architectures for Coreference Algorithms › Entity-based Models · pp. 543–543 · Speech and Language Processing (Jurafsky & Martin, 3rd ed. draft)
...
- **feature** — 7 mentions
- **classifier** — 6 mentions
- **mention-pair** — 5 mentions
...
- ← Prev: [[research/slp/the-mention-rank-architecture]]
