...
summary: "§I Large Language Models › Transformers › Historical Notes: 8.9 • INTERPRETING THE TRANSFORMER which is a kind of abstract component of a network. The induction head circuit is part of the attention computation in transformers, discovered by looking at mini language models with o"
level: "research"
...
§I Large Language Models › Transformers › Historical Notes · pp. 205–206 · Speech and Language Processing (Jurafsky & Martin, 3rd ed. draft)
