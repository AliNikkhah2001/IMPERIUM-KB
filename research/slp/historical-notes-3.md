...
summary: "§I Large Language Models › Logistic Regression › Historical N: CHAPTER 4 • LOGISTIC REGRESSION ∂LCE ∂w j = ∂ ∂w j −[ylogσ(w ·x+b)+(1−y)log(1−σ(w ·x+b))] = −  ∂ ∂wj ylogσ(w ·x+b)+ ∂ ∂w j (1−y)log[1−σ(w ·x+b)]  (4.60) Next, using the chain rule, and relying on the derivative of l"
level: "research"
...
§I Large Language Models › Logistic Regression › Historical Notes · pp. 102–102 · Speech and Language Processing (Jurafsky & Martin, 3rd ed. draft)
...
- ← Prev: [[research/slp/summary-3]]
- Next: [[research/slp/exercises-3]] →
