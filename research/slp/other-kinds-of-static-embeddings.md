---
title: "Other kinds of static embeddings"
summary: "§I Large Language Models › Embeddings › Word2vec › Other kind: 5.6 • VISUALIZING EMBEDDINGS There are many kinds of static embeddings. An extension of word2vec, fasttext fasttext (Bojanowski et al., 2017), addresses a problem with word2vec as we have presented it so far: it has n"
level: "research"
...
§I Large Language Models › Embeddings › Word2vec › Other kinds of static embeddings · pp. 119–119 · Speech and Language Processing (Jurafsky & Martin, 3rd ed. draft)
...
- ← Prev: [[research/slp/learning-skip-gram-embeddings]]
