...
summary: "§I Large Language Models › Retrieval-based Models › Informati: 11.1 • INFORMATION RETRIEVAL Once we have represented each document and query as a weighted vector, we need to score each document."
level: "research"
...
§I Large Language Models › Retrieval-based Models › Information Retrieval › Document Scoring · pp. 249–250 · Speech and Language Processing (Jurafsky & Martin, 3rd ed. draft)
...
- [[pdf:Speech and Language Processing.pdf#page=249|Speech and Language Processing.pdf p. 249]]

## Liens
- Up: [[research/slp/information-retrieval]]
- ← Prev: [[research/slp/term-weighting-tf-idf-and-bm25]]
- Next: [[research/slp/efficiently-finding-documents-the-inverted-index]] →
