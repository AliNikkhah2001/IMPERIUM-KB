---
title: "Datasets"
summary: "§Retrieval-based Models › Datasets: CHAPTER 11 • RETRIEVAL-BASED MODELS trained, or if it was, it was likely trained for simple IR or factoid question-answering tasks, not for the RAG scenario where the retrieved passages are specifically to be used by another LLM for generating "
level: "research"
...
§Retrieval-based Models › Datasets · pp. 18–19 · SLP Chapter 11 (Standalone Chapter)
...
- [[pdf:Speech and Language Processing Chapter 11.pdf#page=18|Speech and Language Processing Chapter 11.pdf p. 18]]

## Liens
- Up: [[research/slp-ch11/retrieval-based-models]]
- ← Prev: [[research/slp-ch11/retrieval-augmented-generation-rag]]
- Next: [[research/slp-ch11/evaluating-question-answering]] →
