---
title: "Summary"
summary: "§Retrieval-based Models › Summary: CHAPTER 11 • RETRIEVAL-BASED MODELS swering directly from the LM with no retrieval component at all is the closed book closed book QA task.5 Thus datasets like Natural Questions can be treated as open book if the solver uses each question’s atta"
level: "research"
...
§Retrieval-based Models › Summary · pp. 20–20 · SLP Chapter 11 (Standalone Chapter)
...
- ← Prev: [[research/slp-ch11/evaluating-question-answering]]
- Next: [[research/slp-ch11/historical-notes]] →
