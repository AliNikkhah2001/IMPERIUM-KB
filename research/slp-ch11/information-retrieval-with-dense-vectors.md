...
summary: "§Retrieval-based Models › Information Retrieval with Dense Ve: 11.3 • INFORMATION RETRIEVAL WITH DENSE VECTORS The classic tf-idf or BM25 algorithms for IR have long been known to have a conceptual flaw: they work only if there is exact overlap of words between the query and docu"
level: "research"
...
§Retrieval-based Models › Information Retrieval with Dense Vectors · pp. 13–14 · SLP Chapter 11 (Standalone Chapter)
...
- [[pdf:Speech and Language Processing Chapter 11.pdf#page=13|Speech and Language Processing Chapter 11.pdf p. 13]]

## Liens
- Up: [[research/slp-ch11/retrieval-based-models]]
- ← Prev: [[research/slp-ch11/evaluation-of-information-retrieval-systems]]
- Next: [[research/slp-ch11/retrieval-augmented-generation-rag]] →
