...
summary: "§Retrieval-based Models › Historical Notes: CHAPTER 11 • RETRIEVAL-BASED MODELS swering directly from the LM with no retrieval component at all is the closed book closed book QA task.5 Thus datasets like Natural Questions can be treated as open book if the solver uses each questi"
level: "research"
...
§Retrieval-based Models › Historical Notes · pp. 20–20 · SLP Chapter 11 (Standalone Chapter)
...
- ← Prev: [[research/slp-ch11/summary]]
- Next: [[research/slp-ch11/exercises]] →
