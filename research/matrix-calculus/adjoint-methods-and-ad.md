...
§Nonlinear Root-Finding, Optimization, and Adjoint Differentiation › Reverse-mode ``Adjoint'' Differentiation › Adjoint methods and AD · pp. 44–44 · Matrix Calculus (MIT 18.S096 Notes)
...
- ← Prev: [[research/matrix-calculus/nonlinear-equations]]
- Next: [[research/matrix-calculus/adjoint-method-example]] →
