...
summary: "§Finite-Difference Approximations › Roundoff error: The truncation error is the inaccuracy arising from the fact that the input perturbation δx is not infinitesimal: we are computing a difference, not a derivative."
level: "research"
...
§Finite-Difference Approximations › Roundoff error · pp. 32–32 · Matrix Calculus (MIT 18.S096 Notes)
...
- ← Prev: [[research/matrix-calculus/order-of-accuracy]]
- Next: [[research/matrix-calculus/other-finite-difference-methods]] →
