---
title: "Hessian matrices of scalar-valued functions"
summary: "§Second Derivatives, Bilinear Maps, and Hessian Matrices › He: Second Derivatives, Bilinear Maps, and Hessian Matrices In this chapter, we apply the principles of this course to second derivatives, which are conceptually just derivatives of derivatives but turn out to have many i"
level: "research"
...
§Second Derivatives, Bilinear Maps, and Hessian Matrices › Hessian matrices of scalar-valued functions · pp. 87–87 · Matrix Calculus (MIT 18.S096 Notes)
...
- Next: [[research/matrix-calculus/general-second-derivatives-bilinear-maps]] →
