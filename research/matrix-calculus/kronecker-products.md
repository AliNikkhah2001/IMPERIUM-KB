...
summary: "§Jacobians of Matrix Functions › Kronecker Products: that the primary way to study matrix functions like this should be to view them as having matrix inputs (A) and matrix outputs (A2), and that one should likewise generally view the derivatives as linear operators on matrices, n"
level: "research"
...
§Jacobians of Matrix Functions › Kronecker Products · pp. 23–28 · Matrix Calculus (MIT 18.S096 Notes)
...
- **column** — 17 mentions
- **product** — 14 mentions
- **matrices** — 13 mentions
- **jacobian** — 13 mentions
- **kronecker** — 13 mentions
- **vector** — 9 mentions
- **linear** — 8 mentions
...
- ← Prev: [[research/matrix-calculus/a-simple-example-the-two-by-two-matrix-square-function]]
