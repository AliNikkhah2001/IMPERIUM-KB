...
§Nonlinear Root-Finding, Optimization, and Adjoint Differentiation › Optimization · pp. 40–41 · Matrix Calculus (MIT 18.S096 Notes)
...
- ← Prev: [[research/matrix-calculus/newton-s-method]]
- Next: [[research/matrix-calculus/reverse-mode-adjoint-differentiation]] →
