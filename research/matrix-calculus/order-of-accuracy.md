...
summary: "§Finite-Difference Approximations › Order of accuracy: The truncation error is the inaccuracy arising from the fact that the input perturbation δx is not infinitesimal: we are computing a difference, not a derivative."
level: "research"
...
§Finite-Difference Approximations › Order of accuracy · pp. 32–32 · Matrix Calculus (MIT 18.S096 Notes)
...
- ← Prev: [[research/matrix-calculus/accuracy-of-finite-differences]]
- Next: [[research/matrix-calculus/roundoff-error]] →
