---
title: "Applications"
summary: "§Derivative of Matrix Determinant and Inverse › Applications: There is also a fancier proof of the theorem using linearization near the identity. Firstly, note that it is easy to see from the properties of determinants that det(I + dA) −1 = tr(dA), and thus det(A + A(A−1dA)) −det"
level: "research"
...
§Derivative of Matrix Determinant and Inverse › Applications · pp. 48–48 · Matrix Calculus (MIT 18.S096 Notes)
...
## Liens
- Up: [[research/matrix-calculus/derivative-of-matrix-determinant-and-inverse]]
- ← Prev: [[research/matrix-calculus/two-derivations]]
- Next: [[research/matrix-calculus/jacobian-of-the-inverse]] →
