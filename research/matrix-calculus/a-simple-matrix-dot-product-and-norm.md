---
title: "A Simple Matrix Dot Product and Norm"
summary: "§Derivatives in General Vector Spaces › A Simple Matrix Dot P: Matrix calculus requires us to generalize concepts of derivative and gradient further, to functions whose inputs and/or outputs are not simply scalars or column vectors."
level: "research"
...
§Derivatives in General Vector Spaces › A Simple Matrix Dot Product and Norm · pp. 34–36 · Matrix Calculus (MIT 18.S096 Notes)
...
- Next: [[research/matrix-calculus/derivatives-norms-and-banach-spaces]] →
