---
title: "Derivatives of Random Functions"
summary: "§Derivatives of Random Functions: These notes are from a guest lecture by Gaurav Arya in IAP 2023. In this class, we’ve learned how to take derivatives of all sorts of crazy functions."
level: "research"
...
§Derivatives of Random Functions · pp. 79–86 · Matrix Calculus (MIT 18.S096 Notes)
...
## Liens
- ← Prev: [[research/matrix-calculus/calculus-of-variations]]
- Next: [[research/matrix-calculus/second-derivatives-bilinear-maps-and-hessian-matrices]] →
