---
title: "Finite-Difference Approximations: Easy Version"
summary: "§Finite-Difference Approximations › Finite-Difference Approxi: In this section, we will be referring to this Julia notebook for calculations that are not included here. Working out derivatives by hand is a notoriously error-prone procedure for complicated functions."
level: "research"
...
§Finite-Difference Approximations › Finite-Difference Approximations: Easy Version · pp. 29–29 · Matrix Calculus (MIT 18.S096 Notes)
...
- ← Prev: [[research/matrix-calculus/why-compute-derivatives-approximately-instead-of-exactly]]
- Next: [[research/matrix-calculus/example-matrix-squaring]] →
