...
§Nonlinear Root-Finding, Optimization, and Adjoint Differentiation › Reverse-mode ``Adjoint'' Differentiation › Nonlinear equations · pp. 44–44 · Matrix Calculus (MIT 18.S096 Notes)
...
- Next: [[research/matrix-calculus/adjoint-methods-and-ad]] →
