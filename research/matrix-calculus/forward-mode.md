---
title: "Forward mode"
summary: "§Differentiating ODE solutions › Example › Forward mode: The Jacobian matrix ∂u ∂p =  ∂u ∂p1 ∂u ∂p2 ∂u ∂p3  is simply a row vector, and satisfies our “forward-mode” ODE: ∂ ∂t ∂u ∂p  = ∂f ∂u ∂u ∂p + ∂f ∂p = (p2 + 2p3u) ∂u ∂p +  u u2  for the initial condition ∂u ∂p t=0 = ∂u0"
level: "research"
...
§Differentiating ODE solutions › Example › Forward mode · pp. 72–72 · Matrix Calculus (MIT 18.S096 Notes)
...
- Next: [[research/matrix-calculus/reverse-mode]] →
