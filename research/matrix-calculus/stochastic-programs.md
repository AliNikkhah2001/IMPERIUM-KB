...
summary: "§Derivatives of Random Functions › Stochastic programs: These notes are from a guest lecture by Gaurav Arya in IAP 2023. In this class, we’ve learned how to take derivatives of all sorts of crazy functions."
level: "research"
...
§Derivatives of Random Functions › Stochastic programs · pp. 79–80 · Matrix Calculus (MIT 18.S096 Notes)
...
- ← Prev: [[research/matrix-calculus/introduction-2]]
- Next: [[research/matrix-calculus/stochastic-differentials-and-the-reparameterization-trick]] →
